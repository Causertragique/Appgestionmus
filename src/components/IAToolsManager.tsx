...
const IAToolsManager: React.FC = () => {
  ...
  const renderToolCard = (tool: IATool) => (
    <div 
      key={tool.id}
      className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-all duration-200 cursor-pointer transform hover:scale-105"
