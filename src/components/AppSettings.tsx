...
import { Settings, Globe, DollarSign, Palette, Monitor, Sun, Moon, Save, RotateCcw, Check } from 'lucide-react';
...
export default function AppSettings({ userRole }: AppSettingsProps) {
  ...
  const getThemeLabel = (theme: Theme) => {
    switch (theme) {
      ...
      case 'auto': return 'Automatique (Système)';
      ...
      <div className="grid gap-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h4 className="font-medium text-gray-900">Thème de l'Application</h4>
          </div>
          <p className="text-sm text-gray-600 mb-3">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            ...
            <div>
              <span className="text-blue-600 font-medium">Thème :</span>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <div className="text-yellow-800 text-sm space-y-1">
            ...
            <p>• Le mode automatique suit les préférences de votre système d'exploitation</p>
